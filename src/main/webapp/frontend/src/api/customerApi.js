...
export const getCustomerById = async (customerId) => {
	return await axios
		.get(`${BASE_URL}/getcustomerbyid/${customerId}`)
...
export const updateCustomer = async (customer) => {
	return await axios
		.post(`${BASE_URL}/updatecustomer`, customer)
		.then((response) => response.data)
		.catch((error) => console.error(`Error adding user: ${error}`));
};
...
export const deleteCustomer = async (customer) => {
	return await axios
		.post(`${BASE_URL}/deletecustomer`, customer)
		.then((response) => response.data)
		.catch((error) => console.error(`Error adding user: ${error}`));
};
...
export const deleteCustomerById = async (customerId) => {
	return await axios
		.get(`${BASE_URL}/deletecust/${customerId}`)
		.then((response) => response.data)
		.catch((error) => console.error(`Error adding user: ${error}`));
};
...
export const getOrdersByCustomerId = async (customerId) => {
	return await axios
		.get(`${BASE_URL}/getordersbycustid/${customerId}`)
		.then((response) => response.data)
		.catch((error) => console.error(`Error adding user: ${error}`));
};
...
export const getCartByCustId = async (customerId) => {
	return await axios
		.get(`${BASE_URL}/getcartbycustid/${customerId}`)
		.then((response) => response.data)
		.catch((error) => console.error(`Error adding user: ${error}`));
};
...
export const getWishListByCustId = async (customerId) => {
	return await axios
		.get(`${BASE_URL}/getwishlistbycustid/${customerId}`)
		.then((response) => response.data)
		.catch((error) => console.error(`Error adding user: ${error}`));
};
